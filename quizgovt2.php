...
.overlay {
  ...
  <h3>2. Government has announced PM-KISAN Scheme to provide assured income support to the Small and Marginal Farmers.<br> What does PM-KISAN stands for?</h3>
  <pre>
    <audio controls>
...
<br/>
    <input type="radio" name="question2">
       <label>1. Pradhan Mantri Krishi Sewa Niyam <br>
       <audio controls>
  <source src="horse.ogg" type="audio/ogg">
...
Your browser does not support the audio element.
    ...
    <input type="radio"  name="question2">
       <label>2. Pradhan Mantri Kisan Sanchay Nidhi <br>
       <audio controls>
  <source src="horse.ogg" type="audio/ogg">
...
Your browser does not support the audio element.
    ...
    <input type="radio" name="question2" id="inculdefile">
       <label for="inculdefile">3. Pradhan Mantri Kisan Samman Nidhi<br>
...
Your browser does not support the audio element.
    ...
    <input type="radio" name="question2">
     <label>4. Pradhan Mantri Krishi Sahyog Niyam <br>
...
<div class="card">
          <div class="card-header card-header-text card-header-primary">
            <div class="card-text">
               ...
               <br>
               <br>
              <h4 class="card-title">1. How much interest rate do we get in Indian Banks for fixed deposits?</h4>
           
 <br>
    <audio controls>
  
  <source src="indian-bank-fd.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
</div>
          </div>
...
<div class=card>
    <input type="radio" id="Fastlearning" name="question1">
       <label for="Fastlearning" style="border:0px;">1.  6.5 to 7 <br>
       
       <audio controls>
  <source src="6.5-7.ogg" type="audio/ogg">
  <source src="6.5-7.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
...
<div class=card>
    <input type="radio"  name="question1">
       <label style="border:0px;">2. 3 to 5 <br>
 ...
 <div class="card">
          <div class="card-header card-header-text card-header-primary">
            <div class="card-text">
               ...
               <br>
               <br>
  <h4 class="card-title">2. Does every bank has different interest rate for fixed deposits?</h4>
  <br>
    <audio controls>
  <source src="horse.ogg" type="audio/ogg">
  <source src="fd-in-bank-different.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
<br/>
</div>
...
<div class=card>
    ...
    <input type="radio" name="question2" id="inculdefile">
       <label for="inculdefile" style="border:0px;">1. Yes <br>
       <audio controls>
...
Your browser does not support the audio element.
   ...
   <div class="col">
      <div class="card">
       <input type="radio"  name="question2">
       <label style="border:0px;">2. No <br>
       <audio controls>
  <source src="horse.ogg" type="audio/ogg">
...
Your browser does not support the audio element.
  ...
  <button class="btn btn-info btn-round">
  EXIT QUIZ<i class="material-icons">navigate_next</i>
  </button>
  </form>
  </div>
