   ...
   <div class="overlay"></div>
    ...
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
     <ul class="nav sidebar-nav">
       ...
       <img src="user.jpg" class="img-fluid" alt="Responsive image">
       </div></div>
       <br><br><br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-8 ml-auto mr-auto">
            <div class="iframe-container">
                <iframe class="embed-responsive-item" height="450" width="700" src="https://www.youtube.com/embed/2gV7QWdUdzk" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>
