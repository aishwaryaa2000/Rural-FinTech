...
<div class="container">
    <div class="row">
        <div class="col-md-8 ml-auto mr-auto">
            <div class="iframe-container">
                <iframe class="embed-responsive-item" height="400" width="700" src="https://www.youtube.com/embed/W_mZTUW9y_4" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
            </div>
        </div>
  ...
  <form action="quizsave.php" method="POST">
  <button class="btn btn-danger btn-round">
  Play a quiz and test yourself <i class="material-icons">navigate_next</i>
  </button>
  </form>
  </div>
    </div>
