...
<div class="card">
          <div class="card-header card-header-text card-header-primary">
            <div class="card-text">
               ...
               <br>
               <br>
              <h4 class="card-title">2. The eligible farmers under PM-KISAN scheme will get direct income support of how much amount by the government annually?</h4>
...
<div class=card>
    <input type="radio" id="Fastlearning" name="question1">
       <label for="Fastlearning" style="border:0px;">1. Rs 6,000 <br>
       
       <audio controls>
  <source src="6000rs.ogg" type="audio/ogg">
  <source src="6000rs.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
...
<div class=card>
    <input type="radio"  name="question1">
       <label style="border:0px;">2. Rs 8,000 <br>
       
       <audio controls>
       <source src="8000rs.ogg" type="audio/ogg">
  <source src="8000rs.mp3" type="audio/mpeg">
Your browser does not support the audio element.
</audio>
